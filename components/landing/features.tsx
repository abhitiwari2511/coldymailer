...
export function Features() {
  const reviews = [
    {
      quote:
        "I sent 50 highly personalized emails in 10 minutes. I got 4 interviews and locked my summer internship at Vercel.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "The way the AI references specific projects from my resume changed everything. It sounds exactly like me, just way more confident.",
      name: "Marcus Johnson",
      role: "Senior · NYU",
    ...
    {
      quote:
        "Previously, I would procrastinate applying because rewriting covers letters was draining. This made it a single click.",
    ...
    <>
      <section className="max-w-6xl mx-auto px-6 pb-24 md:pb-32 relative">
        ...
        >
                ...
                <div className="flex-1 overflow-y-auto p-6 grid grid-cols-1 xl:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <span className="px-3 py-1.5 rounded-md border border-brand text-brand bg-brand/10 text-xs font-medium cursor-pointer">
                          Professional
                        </span>
                        <span className="px-3 py-1.5 rounded-md border border-white/10 text-white/50 hover:bg-white/5 text-xs font-medium cursor-pointer">
                          Casual
                        </span>
                        <span className="px-3 py-1.5 rounded-md border border-white/10 text-white/50 hover:bg-white/5 text-xs font-medium cursor-pointer">
                          Friendly
                  ...
                  <div className="flex flex-col bg-white/[0.02] border border-white/10 rounded-xl overflow-hidden shadow-inner">
                    <div className="h-10 border-b border-white/10 bg-white/[0.03] flex items-center justify-between px-4">
                      <div className="flex items-center gap-2 text-xs font-medium text-white/70">
                        <ChevronLeftIcon className="w-3.5 h-3.5 cursor-pointer" />{" "}
                        Generated Preview
                      </div>
                    ...
                    <div className="p-4 flex-1 overflow-y-auto text-sm text-white/80 leading-relaxed font-sans scrollbar-hide">
                      <div className="mb-4">
                        ...
                        Application for Frontend Developer Internship
                      </div>
                      <div className="space-y-4 text-white/80">
                        <p>
                          Hi{" "}
                          <span className="text-brand font-medium bg-brand/10 px-1 rounded">
                            {"{{recruiter_name}}"}
                          </span>
                          ,
                        </p>
                        <p>
                          I hope you&apos;re doing well. I came across your
                          team&apos;s work on{" "}
                          <span className="text-brand font-medium bg-brand/10 px-1 rounded">
                            {"{{company}}"}
                          </span>{" "}
                          and was really impressed by the scale and impact of
                          your engineering.
                        </p>
                        <p>
                          I&apos;m a Computer Science student with hands-on
                          experience in React, Next.js, and building responsive,
                          user-friendly web applications. I&apos;m passionate
                          about creating real-world solutions and would love the
                          opportunity to contribute and learn from your team.
                        </p>
                        <p>
                          I&apos;ve attached my resume for your review. I&apos;d
                          be excited to discuss how I can add value to your
                          team.
                        </p>
                        <p>
                          Best regards,
              ...
              <div className="w-full md:w-72 bg-black/20 p-6 flex flex-col shrink-0 overflow-y-auto">
                ...
                <div className="border border-white/10 bg-white/[0.04] p-2 rounded-lg flex flex-col gap-2 min-h-[120px] shadow-inner mb-2">
                  <span className="flex items-center gap-2 bg-white/5 border border-white/10 pl-2 pr-1 py-1 rounded text-xs">
                    hr@google.com{" "}
                    <X className="w-3.5 h-3.5 text-white/50 cursor-pointer hover:text-white" />
                  </span>
          ...
          >
            <div className="text-xs font-medium text-white/80 mb-4">
              Campaign status
            </div>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-end">
                ...
                <div className="text-lg font-semibold leading-none text-brand">
                  87
                </div>
              </div>
              <div className="flex justify-between items-end">
                <div className="text-xs text-[#28c840]">Replied (18%)</div>
                <div className="text-lg font-semibold leading-none text-[#28c840]">
                  24
                </div>
              </div>
            </div>
          ...
          >
            <div className="text-xs font-semibold text-white/80 mb-3 border-b border-white/10 pb-2">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          >
            ...
            <p className="mt-6 text-white/60 text-base leading-[1.6] max-w-md">
              Stop copy-pasting generic cover letters. ColdyMailer AI extracts
              your skills from one PDF and weaves them seamlessly into highly
              relevant outreach emails for each specific company.
            </p>
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-white/[0.03] border border-white/5 rounded-xl p-4">
                ...
                <p className="text-sm text-white/50">
                  Upload your PDF once. It&apos;s stored securely via Cloudinary
                  and parsed instantly to build your candidate profile.
                </p>
              </div>
              <div className="bg-white/[0.03] border border-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-[#A4F4FD]/20 p-2 rounded-lg">
                    <Sparkles className="w-4 h-4 text-[#A4F4FD]" />
                  </div>
                  <span className="font-semibold text-sm">
                    2. Claude/OpenAI Generation
                  </span>
                </div>
                <p className="text-sm text-white/50">
                  State of the art models analyze the target company and inject
                  your most relevant projects from your resume into the draft.
                </p>
              </div>
              <div className="bg-white/[0.03] border border-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-[#28c840]/20 p-2 rounded-lg">
                    <Mail className="w-4 h-4 text-[#28c840]" />
                  </div>
                  <span className="font-semibold text-sm">
                    3. Native Gmail Sending
                  </span>
                </div>
                <p className="text-sm text-white/50">
                  Emails aren&apos;t spoofed. They are sent directly from your
                  connected Gmail via OAuth—ensuring maximum deliverability.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          {reviews.map((t, i) => (
            ...
            >
              ...
              <figcaption className="mt-6 pt-5 border-t border-white/10">
                ...
                <div className="text-xs text-brand font-semibold tracking-wide uppercase mt-2">
                  {t.company}
                </div>
              </figcaption>
            </motion.figure>
